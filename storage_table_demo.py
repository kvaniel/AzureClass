...
car.price = 38000
table_service.insert_entity('itemstable', car)
print('Created entry for 2017 Ford Edge...\n')
...
coffee.flavor = 'Dirt'
coffee.sizecup = 'Small'
coffee.pricecup = 80.00
table_service.insert_entity('itemstable', coffee)
print('Created entry for a Small Dirt Flavored Starbucks...\n')
time.sleep(1)
...
coffee.brand = 'Starbucks'
coffee.flavor = 'Dirt'
coffee.sizecup = 'Medium'
coffee.pricecup = 100.00
table_service.insert_entity('itemstable', coffee)
print('Created entry for Medium Dirt Flavored Starbucks...\n')
time.sleep(1)
